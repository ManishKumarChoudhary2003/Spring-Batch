...
import Spring_Batch.Batch_Processing.domain.ProductFieldSetMapper;
import Spring_Batch.Batch_Processing.domain.ProductRowMapper;
import Spring_Batch.Batch_Processing.exception.MyException;
import Spring_Batch.Batch_Processing.listener.*;
import Spring_Batch.Batch_Processing.processor.FilterProductItemProcessor;
import Spring_Batch.Batch_Processing.processor.TransformProductItemProcessor;
import Spring_Batch.Batch_Processing.reader.ProductNameItemReader;
import Spring_Batch.Batch_Processing.skippolicy.MySkipPolicy;
...
//                .writer(jdbcBatchItemWriterWithParameters())
//                .build();
//    }

//    @Bean
//    public Step jdbcItemReader() {
//        return new StepBuilder("JdbcItemReader", jobRepository)
//                .<Product, Product>chunk(3, transactionManager)
//                .reader(jdbcCursorItemReader())
//                .writer(new ItemWriter<Product>() {
//                    @Override
//                    public void write(Chunk<? extends Product> chunk) throws Exception {
//                        System.out.println("Chunk Processing Started jdbcItemReader");
//                        chunk.forEach(System.out::println);
//                        System.out.println("Chunk Processing Ended jdbcItemReader");
//                    }
//                }).build();
//    }
//
...
//                    @Override
//                    public void write(Chunk<? extends Product> chunk) throws Exception {
//                        System.out.println("Chunk Processing Started jdbcPagingItemReaderStep");
//                        chunk.forEach(System.out::println);
//                        System.out.println("Chunk Processing Ended jdbcPagingItemReaderStep");
//                    }
//                }).build();
//    }
//
...
//        return new JobBuilder("Job 1", jobRepository)
//                .start(Step1())
//                .on("COMPLETED").to(jdbcItemReader())
//                .from(jdbcItemReader())
//                .on("COMPLETED").to(jdbcPagingItemReaderStep())
//                .end()
//                .build();
//    }
